...
def run():
    img1 = Image.open('./meta/logo4.jpg')
    img1 = img1.resize((700,700))
    st.image(img1,use_column_width=False)
    st.title("-----ANIMAL SPECIES IDENTIFIER-----")
    st.markdown('''<h4 style='text-align: left; color: #d73b5c;'><center> TEAM GARUDA <center></h4><br><h5><center>Aditya Sharma (0827CS201016)<center></h5><br><h5><center>Amit Kumar Yadav (0827CS201031)<center></h5><br><h5><center>Aashish Pagare (0827CS201005)<center></h5><br><h5><center>Aman Verma (0827CS201028)<center></h5>''',
